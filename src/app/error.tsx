    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50">
      <div className="mb-8">
        ...
        >
          ...
          <path d="M60 60 v-10" stroke="#64748b" strokeWidth="4" strokeLinecap="round" />
        </svg>
      </div>
      ...
      <p className="text-slate-500 text-lg mb-6 text-center max-w-xs">
        We couldn&apos;t connect. Please check your connection or try again later.
      </p>
      <button
        onClick={() => window.location.reload()}
        className="bg-slate-600 text-white rounded-md px-7 py-2 text-base font-medium shadow-md hover:bg-slate-700 transition"
      >
        Retry
      </button>
    </div>
